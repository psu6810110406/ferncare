...
const booking_entity_1 = require("./book/booking.entity");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                database: 'ferncare',
                entities: [booking_entity_1.BookingEntity, user_entity_1.User],
                synchronize: true,
            }),
        ...
        providers: [app_service_1.AppService, bookings_service_1.BookingsService],
    })
], AppModule);
